...
class Store_model extends CI_Model
{
    ...
    public function getItemExist($id): int
    {
    ...
    public function getCategoryExist($route): int
    {
    ...
    public function getCategories($realmid): CI_DB_result
    {
    ...
    public function PurchaseItem($id, $charid): bool
    {
...
if ($command === '') {
    ...
    public function getChildStoreCategory($id): CI_DB_result
    {
